...
Note: You may find the GraphQL schema [here](api/gateway/graphql/business-management/schema.gql)
...
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-pyxis/gateway --api-id=gateway --output-dir=FULL_PATH_TO_REPO/ms-business-management/playground/gateway  --setup-file=FULL_PATH_TO_REPO/ms-business-management/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-business-management/backend/business-management/.env   *WORKING_FOLDER*/ms-business-management/playground/gateway/.env  
